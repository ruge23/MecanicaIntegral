...
import { DATA_ITEMS, BRAND_TRUCK } from '../constants';
...
const FormScreen = () => {
  const [formData, setFormData] = useState<FormData>({
    ...
    invoiceNumber: '',
    companyName: 'García y Asociados',
    companyAddress: 'C/ Paseo Grande, 1',
    companyNIF: 'A12345678',
    companyPhone: '612 456 789',
    companyEmail: 'gasociados@garciasociados.com',
    validityDays: '30',
